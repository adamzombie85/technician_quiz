...
def enrich_questions(questions):
    ...
    for i in range(0, len(to_enrich), batch_size):
        ...
        2. "explanation": 極白話詳解 (1~2句，生活化比喻)
        3. "keyword_tag": 核心名詞
        回傳 JSON 陣列。
        """
...
if __name__ == "__main__":
    new_path = f"{BASE_DIR}/[共同科目題庫] 丙級共同科目_new.json"
    final_path = f"{BASE_DIR}/[共同科目題庫] 丙級共同科目_final.json"
    out_path = f"{BASE_DIR}/[共同科目題庫] 丙級共同科目_merged.json"
